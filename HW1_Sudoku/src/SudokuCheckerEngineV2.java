public class SudokuCheckerEngineV2 {
    public static void main(String[] args) {
        ...
        SudokuBoard board1 = new SudokuBoard("static/boards/empty.sdk");
        ...
        SudokuBoard board2 = new SudokuBoard("static/boards/valid-incomplete.sdk");
        ...
        SudokuBoard board3 = new SudokuBoard("static/boards/valid-complete.sdk");
        ...
        SudokuBoard board4 = new SudokuBoard("static/boards/dirty-data.sdk");
        ...
        SudokuBoard board5 = new SudokuBoard("static/boards/row-violation.sdk");
        ...
        SudokuBoard board6 = new SudokuBoard("static/boards/col-violation.sdk");
        ...
        SudokuBoard board7 = new SudokuBoard("static/boards/row-and-col-violation.sdk");
        ...
        SudokuBoard board8 = new SudokuBoard("static/boards/grid-violation.sdk");
